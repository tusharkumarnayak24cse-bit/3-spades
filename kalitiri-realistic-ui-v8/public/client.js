...
function renderSeats(){
  ...
  state.players.forEach((p,i)=>{
    ...
    seat.className=`seat ${i===state.viewerIndex?"viewer":"opponent"} ${state.turnIndex===i&&state.phase==="playing"?"active":""} ${p.voiceJoined?"voice-connected":""} ${p.voiceMuted?"voice-muted":""}`;
