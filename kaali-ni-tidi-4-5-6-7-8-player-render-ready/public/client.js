...
const i18n = {
  en:{
    ...
    heroTitle:"Play Kaali Ni Tidi with your friends.",heroText:"Choose 4–8 players. New 5-player and 7-player modes keep every scoring point in play by removing only zero-point ranks.",
  ...
  gu:{
    ...
    heroTitle:"મિત્રો સાથે કાળી ની તીડી રમો.",heroText:"હવે 4 થી 8 ખેલાડી મોડ છે. 5 અને 7 ખેલાડી મોડમાં માત્ર 0-પોઇન્ટ રેન્ક કાઢવામાં આવે છે જેથી બધા સ્કોરિંગ પોઇન્ટ રમતમાં રહે.",
