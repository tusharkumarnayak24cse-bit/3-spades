...
### Authoritative 30-second action timer
...
- Bots act quickly without waiting 30 seconds.

Set `TURN_TIMEOUT_MS` to change the timeout. The default is `30000` milliseconds.
...
5. Wait through a 30-second turn once to verify the server performs the automatic action.
